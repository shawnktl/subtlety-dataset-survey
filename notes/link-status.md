...
**Summary:** 77 OK · 7 redirect · 11 forbidden (403/401/429) · 13 dead · 108 total

| Status | HTTP | URL | Found in | Note |
|---|---|---|---|---|
| dead | — | http://db.jsrt.or.jp/eng.php | `datasets/jsrt.md`, `resources/sources.md` | unreachable: timed out |
...
| dead | — | https://physionet.org/content/ct-ich/ | `datasets/physionet-ct-ich.md`, `resources/sources.md` | unreachable: timed out |
| dead | — | https://physionet.org/content/egd-cxr/1.0.0/ | `datasets/egd-cxr.md`, `resources/sources.md` | unreachable: timed out |
| dead | — | https://physionet.org/content/reflacx-xray-localization/1.0.0/ | `datasets/reflacx.md`, `resources/sources.md` | unreachable: timed out |
| dead | — | https://physionet.org/content/vindr-cxr/1.0.0/ | `datasets/vindr-cxr.md`, `resources/sources.md` | unreachable: timed out |
| dead | — | https://physionet.org/content/vindr-mammo/1.0.0/ | `datasets/vindr-mammo.md`, `resources/sources.md` | unreachable: timed out |
...
| forbidden | 403 | https://www.icpsr.umich.edu/web/ICPSR/studies/36684 | `datasets/atlas-v2.md` | bot-block / auth (403) — verify manually in a browser |
...
| redirect | 200 | https://doi.org/10.34894/AECRSD | `datasets/wmh-challenge.md` | -> https://dataverse.nl/citation?persistentId=doi:10.34894/AECRSD |
...
| OK | 203 | https://pubmed.ncbi.nlm.nih.gov/29103086/ | `resources/sources.md` |  |
